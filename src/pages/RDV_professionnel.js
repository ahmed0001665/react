...
export default function RDV_professionnel() {
  return (
    <React.Fragment>
                ...
                <li class="nav-item">
                  <Link to="/rdv_particulier" class="nav-link dropdown-toggle active">Mes RDV</Link>
                    <ul class="dropdown-menu">
                      ...
                      <li class="nav-item">
                          <Link to="/rdv_professionnel" class="nav-link active">RDV professionnel</Link>
                      </li>
                    </ul>
                </li>
              </ul>
    ...
    <section class="RDV-pro pt-65 ">
      <div class="container  min-vh-100" >
        ...
        <div class="Info-container Info-container-2 d-flex justify-content-between align-items-center mt-45">
          ...
          <div class="Info-container-content">
            <div class="center-f-2">
                <p>24 rue de la calade</p>
                <p>34990</p>
                <p>Juvignac</p>
            </div>
          </div>
